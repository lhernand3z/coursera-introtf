...
print('size on x:', size_x, 'size on y:', size_y)

# Different filters to experiment
# unknown filter line
filter = [ [0, 1, 0], [1, -4, 1], [0, 1, 0]]

# filter good for spotting Vertical lines
# filter = [ [-1, -2, -1], [0, 0, 0], [1, 2, 1]]

# filter good for spotting Horizontal lines
...
# Iterate over the image, note the -1 to avoid the edges
for x in range(1, size_x - 1):
    for y in range(1, size_y - 1):
        ...
        # Load into the tranformed image
        image_transformed[x, y] = convolution

# Plot the image. Not the size of the axes, they should be 512x512
plt.gray()
plt.grid(False)
